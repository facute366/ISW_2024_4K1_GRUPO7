...
const Carga = () => {
  ...
  useEffect(() => {
    ...
    if (cargasGuardadas && cargasGuardadas.length > 0) {
      ...
      const listaInicial = [
        { id: 1, nombre: "Paquete A", peso: "5kg", ubicacion: "Almacén 3", fechaAlta: "2024-09-01", activo: true, estado: "registrado" },
        { id: 2, nombre: "Paquete B", peso: "2.5kg", ubicacion: "Almacén 1", fechaAlta: "2024-09-05", activo: true, estado: "registrado" },
        { id: 3, nombre: "Paquete C", peso: "3kg", ubicacion: "Almacén 2", fechaAlta: "2024-09-10", activo: false, estado: "registrado" },
        { id: 4, nombre: "Paquete D", peso: "7kg", ubicacion: "Almacén 4", fechaAlta: "2024-09-12", activo: true, estado: "registrado" },
        { id: 5, nombre: "Paquete E", peso: "1.5kg", ubicacion: "Almacén 5", fechaAlta: "2024-09-15", activo: false, estado: "registrado" },
      ];
